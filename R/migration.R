...
#' @export
fa <- function(...){
  msg(glue(crayon::red(cli::symbol$warning), "  Refer to the NEWS (https://pkg.mitchelloharawild.com/icon/news/) to read the changes."))
  msg(glue(crayon::blue(cli::symbol$info), "  You can use the migration tool `migrate_icon()` to update your documents to this new version."))
