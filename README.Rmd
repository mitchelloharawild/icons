...
You can also search for icons using the `icon_find()` function, which returns
a vector of matching icons. Use `icon_label()` to see which icon set and name
