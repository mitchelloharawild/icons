...
Icons can be inserted inline using inline code `` `r knitr::inline_expr('icon::fontawesome("solid_rocket")')` `` `r icon::fontawesome("solid_rocket")` or `` `r knitr::inline_expr('icon::fontawesome$solid_rocket')` `` `r icon::fontawesome$solid_rocket`.
