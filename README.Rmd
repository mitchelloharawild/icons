...
Icons can be inserted inline using inline code `` `r knitr::inline_expr('icon::fontawesome("solid", "rocket")')` `` `r icon::fontawesome("solid", "rocket")` or `` `r knitr::inline_expr('icon::fontawesome$solid$rocket')` `` `r icon::fontawesome$solid$rocket`.
