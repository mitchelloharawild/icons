...
`feather_icons`, `bioicons`) the same way.
...
Every icon is an `htmltools` tag, so it can be used directly in Shiny UI
code, for example as the `icon` argument of an input:
